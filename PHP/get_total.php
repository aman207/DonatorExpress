...
$crtable_purchases = sprintf("CREATE TABLE `purchases` (
...
$get_packages_purchased = mysql_query("SELECT * FROM purchases");
...
$total_tokens_spent = sprintf("SELECT sum(tokens) AS tokens_sum FROM purchases");
