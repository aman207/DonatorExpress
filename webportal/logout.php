...
<html lang="en">
  <head>
	...
	<meta http-equiv="refresh" content="5; url=<?php echo $dep_url; ?>" />
	...
	<div class="row">
          <div class="col-lg-12">
            <div class="page-header">
              <h2 id="container">Logged out</h2>
            </div>
            <div class="bs-example">
              <div class="jumbotron">
                <p>You have been successfully logged out. You will be redirected to the login page in 5 seconds.</p>
              </div>
            </div>
          </div>
        </div>
