...
<html lang="en">
  <head>
     <title>[Portal] Donator Express - Password Reset Link Sent!</title>
	...
	<div class="row">
          <div class="col-lg-12">
            <div class="page-header">
              <h2 id="container">Password reset link sent!</h2>
            </div>
            <div class="bs-example">
              <div class="jumbotron">
                <p>An email has been sent to the email address provided that contains the link to reset the password. You will be redirected to the login page in 10 seconds.</p>
              </div>
            </div>
          </div>
        </div>
